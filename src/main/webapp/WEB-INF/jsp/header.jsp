        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <c:choose>
                <c:when test="${not empty sessionScope.person}">
                    <a class="nav-link" href="/Cabinet-1.0-SNAPSHOT/controller?command=cab" role="button">Личный
                        кабинет</a>
                ...
                <c:otherwise>
                    <a class="btn btn-primary" href="/Cabinet-1.0-SNAPSHOT/controller?command=login"
                       role="button">Войти</a>
